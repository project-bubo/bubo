...
//        die();
        ...
        foreach ($labels as $labelId => $label) {
            $uLabels[$labelId] = \Bubo\Utils\MultiValues::unserializeArray($label);
...
//
    ...
    public function savePageSorting($labelId, $parentId, $items) {
        ...
        if ($res && \Bubo\Utils\MultiValues::unserialize($res)) {
            $pageSort = \Bubo\Utils\MultiValues::unserialize($res);
        }
